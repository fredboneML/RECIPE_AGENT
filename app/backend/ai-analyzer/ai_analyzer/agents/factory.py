    ...
    def create_response_analyzer_agent(tenant_code: str) -> Agent:
        ...
        return Agent(
            ...
            instructions=[
                ...
                "Provide a brief summary of the response analysis.",
                "Highlight any actionable insights or recommendations.",
                "When analyzing SQL query results, base your analysis ONLY on the SQL results provided, not on any call transcriptions that may be included in the prompt.",
